...
import { findsSeedsLocation, getLowestLocation, mapStringsToNestedNumbers } from "./utils";
...
const solution = (fileName: string): number => {
    ...
    const locations: number[] = findsSeedsLocation(seeds, maps);

    return getLowestLocation(locations);
}

console.log(solution('data/example_')) // 35
console.log(solution('data/input_')) // 111627841
